...
/// A spin lock provided by the C Standard Library.
///
/// A spin lock polls to check the state of the lock, which is much faster
/// when there isn't contention, and may cause unexpected priority inversion
/// on a platform that suspends threads, like Darwin.
